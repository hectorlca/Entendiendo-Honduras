...
leaf.transform <- spTransform(mun.merge,  CRS("+init=epsg:4326"))

leaflet(leaf.transform) %>%
  setView(lng = -87.046650, lat = 14.580856 , zoom = 8) %>%
  addProviderTiles("Esri.WorldStreetMap") %>%
  addPolygons(data = leaf.transform,
               fillColor = "blue",
              color = "gray80")
